...
with open('data/iris.data.csv', 'r') as f:
  for line in f:
    ...
    row = line.split(',')[0:4]
    # convert every item in row from a string to a float using map(), then convert back into a list. The map function works perfectly yet throws an error in Python 3 as it has been deprecated.
